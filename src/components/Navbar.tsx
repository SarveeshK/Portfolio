      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            ...
            className="fixed inset-0 top-0 left-0 w-full h-full bg-[var(--bg-primary)] z-40 md:hidden flex flex-col pt-20 px-6 pb-8"
          >
            ...
            <a
              ...
              rel="noopener noreferrer"
              onClick={() => setIsMobileMenuOpen(false)}
              className="flex items-center justify-center gap-2 bg-[var(--accent-color)] text-white py-4 rounded-xl font-bold text-base hover:opacity-90 transition-opacity mt-4"
            >
              View Resume
            </a>
          </motion.div>
